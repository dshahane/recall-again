...
export const PALETTE_DATA = [
    {
        ...
        items: [
            ...
            { label: "Timer", kind: NodeKind.TimerTrigger }
        ]
    },
    {
        label: "Models",
    ...
    },
    {
        ...
        items: [
            { label: "BME Cat", kind: NodeKind.Catalog },
            { label: "CIF", kind: NodeKind.Catalog },
            { label: "cXML", kind: NodeKind.Catalog },
            { label: "Reviews", kind: NodeKind.Reviews },
            { label: "SQL", kind: NodeKind.Sql },
            { label: "SparQL", kind: NodeKind.Sparql },
            { label: "Sheet", kind: NodeKind.Sheet }
        ]
    },
    {
        label: "Flow Control",
